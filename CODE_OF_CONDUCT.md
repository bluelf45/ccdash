...
maintainer through GitHub's private vulnerability reporting on this repository (Security →
Report a vulnerability), which is private to the maintainer, or by direct message to
[@bluelf45](https://github.com/bluelf45). All complaints will be reviewed and investigated
promptly and fairly.
